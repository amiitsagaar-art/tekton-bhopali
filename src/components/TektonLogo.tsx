  ...
  return (
    <svg viewBox="0 0 200 200" className={className} xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <filter id="lgShadow" x="-10%" y="-10%" width="120%" height="120%">
      ...
      {/* Main building body */}
      <rect x="52" y="72" width="48" height="52" rx="2" fill="url(#innerGold)" />
      {/* Building roof triangle */}
      <polygon points="46,72 76,48 106,72" fill="url(#innerGold)" />
      {/* Building windows */}
      ...
      <circle cx="136" cy="76" r="18" fill="none" stroke="url(#innerGold)" strokeWidth="9" />
